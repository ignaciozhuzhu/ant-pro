...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="职称名称">
...
@connect(({ settitle, loading }) => ({
  settitle,
  loading: loading.models.settitle,
}))
@Form.create()
export default class TableList extends PureComponent {
  ...
  render() {
    const { settitle: { data }, loading } = this.props;
